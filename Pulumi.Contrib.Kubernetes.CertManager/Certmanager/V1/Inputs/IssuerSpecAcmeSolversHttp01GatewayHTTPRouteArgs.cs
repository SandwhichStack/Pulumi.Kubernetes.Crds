...
namespace Pulumi.Contrib.Kubernetes.CertManager.Certmanager.V1.Inputs
{
    ...
    public class IssuerSpecAcmeSolversHttp01GatewayHTTPRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("parentRefs")]
        private InputList<IssuerSpecAcmeSolversHttp01GatewayHTTPRouteParentRefsArgs>? _parentRefs;
        ...
        /// </summary>
        public InputList<IssuerSpecAcmeSolversHttp01GatewayHTTPRouteParentRefsArgs> ParentRefs
        {
            get => _parentRefs ?? (_parentRefs = new InputList<IssuerSpecAcmeSolversHttp01GatewayHTTPRouteParentRefsArgs>());
