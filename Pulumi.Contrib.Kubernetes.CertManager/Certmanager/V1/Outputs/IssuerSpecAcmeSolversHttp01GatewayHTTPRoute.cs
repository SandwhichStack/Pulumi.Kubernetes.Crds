...
namespace Pulumi.Contrib.Kubernetes.CertManager.Certmanager.V1.Outputs
{
    ...
    public sealed class IssuerSpecAcmeSolversHttp01GatewayHTTPRoute
    {
        ...
        /// </summary>
        public readonly ImmutableArray<IssuerSpecAcmeSolversHttp01GatewayHTTPRouteParentRefs> ParentRefs;
        /// <summary>
        ...
        private IssuerSpecAcmeSolversHttp01GatewayHTTPRoute(
            ...
            ImmutableArray<IssuerSpecAcmeSolversHttp01GatewayHTTPRouteParentRefs> parentRefs,
