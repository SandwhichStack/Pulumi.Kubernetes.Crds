...
namespace Pulumi.Contrib.Kubernetes.CertManager.Certmanager.V1.Outputs
{
    ...
    public sealed class ClusterIssuerSpecVaultAuthKubernetes
    {
        ...
        /// </summary>
        public readonly ClusterIssuerSpecVaultAuthKubernetesServiceAccountRef ServiceAccountRef;
        ...
        private ClusterIssuerSpecVaultAuthKubernetes(
            ...
            ClusterIssuerSpecVaultAuthKubernetesServiceAccountRef serviceAccountRef)
        {
            MountPath = mountPath;
            Role = role;
            SecretRef = secretRef;
