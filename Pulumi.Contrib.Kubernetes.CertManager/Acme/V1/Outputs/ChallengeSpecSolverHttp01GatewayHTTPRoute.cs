...
namespace Pulumi.Contrib.Kubernetes.CertManager.Acme.V1.Outputs
{
    ...
    public sealed class ChallengeSpecSolverHttp01GatewayHTTPRoute
    {
        ...
        /// </summary>
        public readonly ImmutableArray<ChallengeSpecSolverHttp01GatewayHTTPRouteParentRefs> ParentRefs;
        /// <summary>
        ...
        private ChallengeSpecSolverHttp01GatewayHTTPRoute(
            ...
            ImmutableArray<ChallengeSpecSolverHttp01GatewayHTTPRouteParentRefs> parentRefs,
