...
namespace Pulumi.Contrib.Kubernetes.CertManager
{
	...
	internal sealed class CertManagerResourceTypeAttribute : Pulumi.ResourceTypeAttribute
	{
		public CertManagerResourceTypeAttribute(string type) : base(type, Utilities.Version)
		{
		}
	}
}
