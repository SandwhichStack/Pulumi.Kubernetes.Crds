...
namespace Pulumi.ArgoCD.Argoproj.V1Alpha1
{
    ...
    /// </summary>
    [ArgoCDResourceType("kubernetes:argoproj.io/v1alpha1:AppProject")]
    public partial class AppProject : KubernetesResource
    {
        ...
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Argoproj.V1Alpha1.AppProjectStatus> Status { get; private set; } = null!;
...
namespace Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1
{
    ...
    public class AppProjectArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiVersion")]
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1.AppProjectStatusArgs>? Status { get; set; }

        public AppProjectArgs()
        {
        }
        public static new AppProjectArgs Empty => new AppProjectArgs();
    }
}
