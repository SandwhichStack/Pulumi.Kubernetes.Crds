...
namespace Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1
{
    ...
    public class ApplicationSetSpecTemplateSpecSourceKustomizeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1.ApplicationSetSpecTemplateSpecSourceKustomizePatchesArgs>? _patches;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1.ApplicationSetSpecTemplateSpecSourceKustomizePatchesArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Pulumi.Kubernetes.Types.Inputs.Argoproj.V1Alpha1.ApplicationSetSpecTemplateSpecSourceKustomizePatchesArgs>());
            set => _patches = value;
        }
